...
### [コントロールセンター・メニューバー設定](docs/control-center-and-menubar.md)
...
#### [volta](docs/volta.md)
Node のバージョン管理ツール。高速で、プロジェクトごとに Node バージョンを自動切り替えできる。
...
デザインツール。Web ベースで、共同編集が可能。UI/UX デザインで広く使われている。

#### [Linear](https://linear.app/download)
プロジェクト管理ツール。開発チーム向けに最適化されており、Issue 管理が効率的。

#### [Python](docs/python.md)
プログラミング言語。データ分析、機械学習、Web 開発など幅広い用途で使われている。

#### [Golang](docs/golang.md)
プログラミング言語。Google が開発。並行処理が強く、高速な実行が特徴。
